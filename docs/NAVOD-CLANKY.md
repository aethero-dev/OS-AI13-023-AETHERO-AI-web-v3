...
`aethero.cz/blog/ai-seo-2026/`, tentýž název v `en/` →
`aethero.agency/blog/ai-seo-2026/`. Čeština běží na `.cz`,
...
1. samotný článek — `aethero.cz/blog/<nazev-souboru>/`
2. výpis `aethero.cz/blog/` a karta na homepage
...
2026-08-31: sitemapa i párování jazyků se generují z článků, přibylo
